...
<!-- Social media Icons-->	
				...
				<div class="container">
					...
					<nav class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item "><a href="events/index.php">Events</a></li>
	...
	if(isset($_POST['submit'])){
		...
		if(mail($to, $subject, $message, $headers)){
			echo "<h2>Sent Successfully!<br> Thank you"." ".$name."</h2>";
		}
		else{
...
<div class="row">
							<div class="col-md-6">
								<form action="mail_handler.php"  method="post" class="contact-form">
									<input type="text" placeholder="Your name.." name="name" required>
									<input type="email" placeholder="Email Address.." name="email" required>
									<input type="tel" placeholder="Contact No" name="phone">
							...
							<div class="col-md-6">
								<div class="map-wrapper">
									<img src="manu/contact.jpg" style="width: 100%;">
									
									<!--address>
										<div class="row">
											<div class="col-sm-6">
												<strong>Manuraj Singh Rajput</strong>
												
											</div>
											<div class="col-sm-6">
												<a href="mailto:flutist.manuraj@gmail.com">flutist.manuraj@gmail.com</a> <br>
			...
			<footer class="site-footer">
				<div class="container">
					...
					<address>
						<p>Manuraj Singh Rajput<br><!--<a href="tel:354543543">Mobile number</a></a>--> <br> <a href="mailto:flutist.manuraj@gmail.com">flutist.manuraj@gmail.com</a></p> 
					</address> 
					...
					<p class="copy">Copyright 2020 Manuraj Singh Rajput.Developed By Harshul Gupta: All right reserved</p>
				</div>
			</footer> <!-- .site-footer -->
